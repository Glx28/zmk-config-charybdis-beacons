...
window.CHARYBDIS_FINAL_LAYOUT = {
  ...
  "version": "final-v1.8-operational-pointer-travel-full-every-key-reapply",
  "device": "V&Z-Charydbis",
  "policy": "Full ZMK Studio reapply generated from the final v1.8 verifier expected map. Applies every visible key on every visible layer, including unchanged/default/transparent keys, programming and language helpers, mouse, RPG/Game Layer 7, and Layer 8 pointer travel. PMW3610 CPI/snipe tuning remains firmware-level and is not a Studio key binding.",
